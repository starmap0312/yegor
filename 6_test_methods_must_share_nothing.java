...
// why is it bad?
//   shared literal MSG introduced an unnatural coupling between two test methods
...
// why is it bad?
//   two testing methods are decoupled (they have their own test object and strings: "something"
//   but the code is duplicated, as "something" appear four times
//
// (good design: reducing the code duplication)
class FooTest {
